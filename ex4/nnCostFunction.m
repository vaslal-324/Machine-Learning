...
%Part 1: Forward prop and compute the cost (unregularised cost function)
...
%Part 1 b: Regularised cost function
%using for loop :
...
%    reg_1=reg_1+Theta1(i,j).^2;
%  endfor
%endfor

%for i=1:size(Theta2,1)
%  for j=2:size(Theta2,2)
%    reg_2=reg_2+Theta2(i,j).^2;
%  endfor
%endfor
